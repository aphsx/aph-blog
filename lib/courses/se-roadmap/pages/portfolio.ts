...
export const portfolioPages: Record<string, Page> = {
  portfolio: {
    slug: "portfolio",
    title: { th: "สร้าง Portfolio & Projects", en: "" },
    lead: { th: "ในปี 2026 portfolio คือหลักฐานที่พิสูจน์ความสามารถได้โดยตรง — สำคัญมากสำหรับ junior", en: "" },
  ...
  "ai-tools-2026": {
    slug: "ai-tools-2026",
    title: { th: "AI Tools สำหรับนักพัฒนา 2026", en: "" },
    lead: { th: "การใช้ AI เสริมการทำงานและการเรียนรู้เป็นทักษะที่สร้างความได้เปรียบในปี 2026", en: "" },
    group: "Portfolio & Projects",
    blocks: {
      th: [
