...
export const oopBasicsPages: Record<string, Page> = {
  ...
  "oop-class": {
    slug: "oop-class",
    title: "Class & Object",
    lead: "พิมพ์เขียว (class) กับของจริง (object), attribute, method, self และ __init__ — รากฐานของ OOP",
  ...
  "oop-pillars": {
    slug: "oop-pillars",
    title: "4 เสาหลักของ OOP",
    lead: "Encapsulation, Inheritance, Polymorphism, Abstraction — แนวคิดหลักที่มักถูกถามในสัมภาษณ์ พร้อมตัวอย่าง",
    group: "บทที่ 5: OOP & การออกแบบโปรแกรม",
    blocks: [
  ...
  "oop-relationships": {
    ...
    lead: "ความสัมพันธ์ \"เป็น\" (is-a) กับ \"มี\" (has-a) และเมื่อไหร่ควรเลือกแบบไหน",
    group: "บทที่ 5: OOP & การออกแบบโปรแกรม",
    blocks: [
  ...
  "oop-design": {
    slug: "oop-design",
    title: "หลักการออกแบบโค้ดที่ดี",
    lead: "DRY, Single Responsibility, KISS, ตั้งชื่อให้ดี และเมื่อไหร่ควร (หรือไม่ควร) ใช้ OOP",
    group: "บทที่ 5: OOP & การออกแบบโปรแกรม",
    blocks: [
