...
export const webApiDbPages: Record<string, Page> = {
  ...
  "web-how": {
    slug: "web-how",
    title: { th: "เว็บทำงานอย่างไร", en: "" },
    lead: { th: "Client/Server, HTTP, HTTP methods และ status code — ภาพรวมการสื่อสารเบื้องหลังทุกเว็บที่คุณใช้", en: "" },
  ...
  "web-api": {
    slug: "web-api",
    title: { th: "API, JSON & REST", en: "" },
    lead: { th: "ช่องทางให้โปรแกรมคุยกัน, รูปแบบข้อมูล JSON และแนวทางออกแบบ REST — พร้อมเรียก API จริงด้วย Python", en: "" },
    group: "บทที่ 6: เว็บ, API & ฐานข้อมูล",
    blocks: {
      th: [
  ...
  "web-sql": {
    slug: "web-sql",
    title: { th: "ฐานข้อมูล & SQL", en: "" },
    lead: { th: "เก็บข้อมูลถาวรเป็นตาราง และสั่งงานด้วย SQL — SELECT, INSERT, UPDATE, DELETE และพื้นฐานที่ต้องรู้", en: "" },
    group: "บทที่ 6: เว็บ, API & ฐานข้อมูล",
    blocks: {
      th: [
  ...
  "web-fullstack": {
    slug: "web-fullstack",
    title: { th: "ภาพรวม Full-stack & ไปต่อที่ไหน", en: "" },
    lead: { th: "ชิ้นส่วนทั้งหมด — Frontend + Backend + Database — ประกอบกันเป็นแอปจริงอย่างไร และเส้นทางต่อจากนี้", en: "" },
    group: "บทที่ 6: เว็บ, API & ฐานข้อมูล",
    blocks: {
      th: [
