...
export const algorithmsBigoPages: Record<string, Page> = {
  ...
  "algo-thinking": {
    slug: "algo-thinking",
    title: { th: "คิดเป็นขั้นตอน (Algorithmic Thinking)", en: "" },
    lead: { th: "อัลกอริทึมคืออะไร, แตกปัญหาเป็นขั้นตอน, เขียน pseudocode ก่อนลงโค้ดจริง", en: "" },
  ...
  "algo-bigo": {
    slug: "algo-bigo",
    title: { th: "Big-O Notation — วัดประสิทธิภาพ", en: "" },
    lead: { th: "บอกว่าเมื่อข้อมูลใหญ่ขึ้น อัลกอริทึมทำงานหนักขึ้นเร็วแค่ไหน — ภาษากลางในการพูดถึงความเร็ว", en: "" },
    group: "บทที่ 4: อัลกอริทึม & Big-O",
    blocks: {
      th: [
  ...
  "algo-search": {
    slug: "algo-search",
    title: { th: "การค้นหา (Searching)", en: "" },
    lead: { th: "Linear search ไล่ดูทีละตัว O(n) เทียบกับ Binary search แบ่งครึ่ง O(log n) ที่เร็วกว่ามากบนข้อมูลที่เรียงแล้ว", en: "" },
    group: "บทที่ 4: อัลกอริทึม & Big-O",
    blocks: {
      th: [
  ...
  "algo-sort": {
    slug: "algo-sort",
    title: { th: "การเรียงลำดับ (Sorting)", en: "" },
    lead: { th: "เข้าใจหลักการเรียงลำดับพื้นฐาน complexity ของแต่ละแบบ และการใช้ sorted() ในงานจริง", en: "" },
    group: "บทที่ 4: อัลกอริทึม & Big-O",
    blocks: {
      th: [
  ...
  "algo-recursion": {
    slug: "algo-recursion",
    title: { th: "Recursion — ฟังก์ชันที่เรียกตัวเอง", en: "" },
    lead: { th: "แก้ปัญหาด้วยการแบ่งเป็นปัญหาย่อยที่เล็กลง — base case, recursive case และวิธีคิดให้ออก", en: "" },
    group: "บทที่ 4: อัลกอริทึม & Big-O",
    blocks: {
      th: [
  ...
  "algo-patterns": {
    slug: "algo-patterns",
    title: { th: "เทคนิคที่เจอบ่อย (Common Patterns)", en: "" },
    lead: { th: "Two pointers, sliding window และ hash map — สามเทคนิคที่ลด complexity และแก้โจทย์สัมภาษณ์ได้ครึ่งค่อนข้อ", en: "" },
    group: "บทที่ 4: อัลกอริทึม & Big-O",
    blocks: {
      th: [
