...
export const dataStructuresPages: Record<string, Page> = {
  ...
  "ds-list": {
    slug: "ds-list",
    title: { th: "List / Array — โครงสร้างที่ใช้บ่อยที่สุด", en: "" },
    lead: { th: "เก็บข้อมูลหลายค่าในตัวแปรเดียว เข้าถึงด้วย index, slicing, เมธอดครบ และลิสต์ 2 มิติ", en: "" },
  ...
  "ds-string": {
    slug: "ds-string",
    title: { th: "String — ลำดับของตัวอักษร", en: "" },
    lead: { th: "ข้อความก็เป็นลำดับเหมือนลิสต์ — index, slice ได้ พร้อมเมธอดจัดการข้อความที่เจอบ่อยในงานจริงและข้อสอบ", en: "" },
    group: "บทที่ 3: โครงสร้างข้อมูล",
    blocks: {
      th: [
  ...
  "ds-dict": {
    slug: "ds-dict",
    title: { th: "Dictionary — คู่ key-value ที่ค้นหาเร็ว", en: "" },
    lead: { th: "เก็บข้อมูลเป็นคู่ \"กุญแจ → ค่า\" เข้าถึงด้วย key ค้นหาเร็วระดับ O(1) — หนึ่งในโครงสร้างที่ทรงพลังที่สุด", en: "" },
    group: "บทที่ 3: โครงสร้างข้อมูล",
    blocks: {
      th: [
  ...
  "ds-set-tuple": {
    slug: "ds-set-tuple",
    title: { th: "Set & Tuple", en: "" },
    lead: { th: "Set เก็บค่าไม่ซ้ำและเช็คสมาชิกเร็ว · Tuple คือลิสต์ที่แก้ไม่ได้ เหมาะกับข้อมูลคงที่", en: "" },
    group: "บทที่ 3: โครงสร้างข้อมูล",
    blocks: {
      th: [
  ...
  "ds-choose": {
    slug: "ds-choose",
    title: { th: "เลือกใช้โครงสร้างไหน + Comprehension", en: "" },
    lead: { th: "สรุปการเลือกโครงสร้างข้อมูลให้เหมาะกับงาน และเขียน list/dict comprehension แบบกระชับ", en: "" },
    group: "บทที่ 3: โครงสร้างข้อมูล",
    blocks: {
      th: [
