...
export const day20Page: Record<string, Page> = {
  "py30-day20": {
    slug: "py30-day20",
    title: { th: "วันที่ 20 — ตัวจัดการแพ็กเกจ (Package Manager)", en: "" },
    lead: { th: "เรียนรู้การใช้ PIP จัดการ packages ใน Python การดึงข้อมูลจาก URL ด้วย requests และการสร้าง Package เป็นของตัวเอง", en: "" },
