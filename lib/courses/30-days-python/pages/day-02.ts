...
export const day02Page: Record<string, Page> = {
  "py30-day02": {
    slug: "py30-day02",
    title: { th: "วันที่ 2 — ตัวแปร & ฟังก์ชันพื้นฐาน (Variables & Built-in Functions)", en: "" },
    lead: { th: "เรียนรู้การสร้างตัวแปร, ชนิดข้อมูล และฟังก์ชันในตัวที่ Python มีให้ใช้งานทันที", en: "" },
