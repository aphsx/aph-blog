...
export const day14Page: Record<string, Page> = {
  "py30-day14": {
    slug: "py30-day14",
    title: { th: "วันที่ 14 — Higher Order Functions", en: "" },
    lead: { th: "เรียนรู้ Higher Order Functions, Closures, Decorators และ Built-in functions อย่าง map, filter และ reduce ใน Python", en: "" },
