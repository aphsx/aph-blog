...
export const day17Page: Record<string, Page> = {
  "py30-day17": {
    slug: "py30-day17",
    title: { th: "วันที่ 17 — จัดการข้อผิดพลาด (Exception Handling)", en: "" },
    lead: { th: "เรียนรู้การจัดการ Exception ด้วย try/except/else/finally พร้อม Packing/Unpacking Arguments, Spreading, Enumerate และ Zip", en: "" },
