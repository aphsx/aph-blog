...
export const day22Page: Record<string, Page> = {
  "py30-day22": {
    slug: "py30-day22",
    title: { th: "วันที่ 22 — Web Scraping", en: "" },
    lead: { th: "เรียนรู้การดึงข้อมูลจากเว็บไซต์ด้วย Python โดยใช้ requests และ BeautifulSoup4 เพื่อเก็บข้อมูลและนำไปใช้งานในรูปแบบต่างๆ", en: "" },
