...
export const day12Page: Record<string, Page> = {
  "py30-day12": {
    slug: "py30-day12",
    title: { th: "วันที่ 12 — โมดูล (Modules)", en: "" },
    lead: { th: "เรียนรู้การสร้างและนำเข้า Module ใน Python ทั้ง custom modules และ built-in modules เช่น os, sys, math, statistics, string และ random", en: "" },
