...
export const day16Page: Record<string, Page> = {
  "py30-day16": {
    slug: "py30-day16",
    title: { th: "วันที่ 16 — วันที่และเวลา (Python DateTime)", en: "" },
    lead: { th: "เรียนรู้การจัดการวันที่และเวลาใน Python ด้วย datetime module ตั้งแต่การดึงข้อมูลวันเวลา การ format ด้วย strftime จนถึง timedelta", en: "" },
