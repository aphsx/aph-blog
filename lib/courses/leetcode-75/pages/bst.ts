...
export const bstPages: Record<string, Page> = {
  "lc75-intro-bst": {
    ...
    def __init__(self, val=0, left=None, right=None):
        ...
        {
          t: "p",
          c: "ประกอบต้นเดียวกันด้วยมือในโค้ด จะได้โครงสร้างเดียวกับกราฟด้านบน:",
        },
        {
          t: "codeout",
          lang: "python",
...
9`,
        ...
        {
          t: "p",
          c: "ช่วงท้ายของกราฟด้านบนเดินซ้ายให้สุด แล้วแตะตัวเอง แล้วไปขวา — เพราะค่าน้อยอยู่ซ้าย ค่ามากอยู่ขวา ลำดับที่ได้จึงเรียงเองโดยไม่ต้อง sort ลองรันให้เห็นตัวเลข:",
        },
        {
          t: "codeout",
          lang: "python",
...
print(inorder(root))`,
    ...
    return root                       # ค่าซ้ำ: ไม่ทำอะไร (โจทย์นี้ค่าไม่ซ้ำ)`,
        ...
        {
          t: "p",
          c: "ลบยากกว่าค้นเพราะต้องคงกฎ BST ไว้ เจอโหนดแล้วดูว่ามีลูกกี่ตัว — กด Next ไล่ทั้งสามกรณีบนกราฟ แล้วค่อยไปลงมือในข้อ 42",
        },
        {
          t: "table",
        ...
        {
          t: "p",
          c: "ความเร็วของ search / insert / delete ทั้งหมดผูกกับ height ไม่ใช่จำนวนโหนด — กด Next เทียบการค้นค่าบนต้นสมดุลกับต้นเอียง",
        },
        { t: "viz", id: "bst-height" },
        {
          t: "table",
