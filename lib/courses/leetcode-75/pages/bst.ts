  ...
  "lc75-intro-bst": {
    ...
    blocks: {
      th: [
              ...
              {
                t: "image",
                src: "/leetcode-75/bst-search.gif",
                alt: "BST search: compare with node then go left or right",
                caption:
                  "BST Search: ค่าน้อยกว่าโหนด → ไปซ้าย · มากกว่า → ไปขวา — ตัดครึ่งทิ้งทุกก้าว",
              },
