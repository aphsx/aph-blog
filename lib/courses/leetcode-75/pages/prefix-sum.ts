...
print(prefix[j + 1] - prefix[i])  # 6` },
  ...
  "lc75-p18": {
    slug: "lc75-p18",
    title: "ข้อ 18 · LC1732 Find the Highest Altitude (ความสูงมากสุด) 🟢",
    lead: "ไต่ altitude (ระดับความสูง) ตาม gain ที่ให้มา แล้วหา highest point (จุดสูงสุด) ที่ไปถึง",
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ Find the Highest Altitude: นักปั่นจักรยานเริ่มที่ altitude (ระดับความสูง) 0 มี array (ลิสต์) gain โดย gain[i] คือค่าต่างของ altitude ระหว่างจุดที่ i กับ i+1 ให้หาว่า highest point (จุดสูงสุด) ที่นักปั่นไปถึงมี altitude เท่าไร" },
      { t: "ul", c: [
...
0` },
  ...
  "lc75-p19": {
    slug: "lc75-p19",
    title: "ข้อ 19 · LC724 Find Pivot Index (หา pivot index) 🟢",
    lead: "หา index ที่ผลรวมฝั่งซ้ายเท่ากับฝั่งขวา โดยไม่บวกซ้ำทุกครั้ง",
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ Find Pivot Index: มี array (ลิสต์) ตัวเลข nums ให้หา index (ตำแหน่ง) ที่เป็น pivot (จุดสมดุล) นั่นคือ index ที่ผลรวมของเลขทางซ้ายทั้งหมดเท่ากับผลรวมของเลขทางขวาทั้งหมด (ตัวที่ index นั้นไม่นับทั้งสองฝั่ง) ให้ return index ที่เจอตัวแรก (ซ้ายสุด) ถ้าไม่มีให้ return -1" },
      { t: "ul", c: [
