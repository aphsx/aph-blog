...
export const triePages: Record<string, Page> = {
  "lc75-intro-trie": {
    ...
    lead: "tree structure ที่เก็บคำโดย share prefix ร่วมกัน search และเติมคำได้เร็วตามความยาวคำ",
    group: "LeetCode 75",
    blocks: [
...
def insert(root, word):
  ...
  "lc75-p70": {
    slug: "lc75-p70",
    title: "ข้อ 70 · LC208 Implement Trie (Prefix Tree) (สร้าง Trie) 🟡",
...
True` },
  ...
  "lc75-p71": {
    slug: "lc75-p71",
    title: "ข้อ 71 · LC1268 Search Suggestions System (ระบบแนะนำคำค้น) 🟡",
