...
export const intervalsPages: Record<string, Page> = {
  "lc75-intro-intervals": {
    ...
    lead: "sort (เรียง) interval ก่อน แล้วใช้ greedy เทียบ interval ติดกัน เพื่อจัดการปัญหาช่วงที่ทับซ้อน",
    group: "LeetCode 75",
    blocks: [
...
for start, end in intervals:
  ...
  "lc75-p72": {
    slug: "lc75-p72",
    title: "ข้อ 72 · LC435 Non-overlapping Intervals (ช่วงที่ไม่ทับกัน) 🟡",
    lead: "หาจำนวน interval ที่ต้องลบน้อยที่สุดให้ interval ที่เหลือไม่ overlap ด้วย greedy เก็บ interval ที่จบเร็วก่อน",
    group: "LeetCode 75",
    blocks: [
...
0` },
  ...
  "lc75-p73": {
    slug: "lc75-p73",
    title: "ข้อ 73 · LC452 Minimum Number of Arrows to Burst Balloons (ลูกศรเจาะลูกโป่ง) 🟡",
    lead: "หาจำนวนลูกศรน้อยสุดที่เจาะลูกโป่งทุกลูก ด้วย greedy ยิงที่ end ของลูกที่จบเร็วสุด",
    group: "LeetCode 75",
    blocks: [
