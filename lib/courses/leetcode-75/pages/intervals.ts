...
for start, end in intervals:
  ...
  "lc75-p72": {
    ...
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ Non-overlapping Intervals ให้ array (ลิสต์) ของ interval (ช่วง) ชื่อ intervals ให้หาจำนวน interval ที่ต้องลบออกน้อยที่สุด เพื่อให้ interval ที่เหลือไม่ overlap (ทับ) กันเลย โดย interval ที่ปลายชนกันพอดี เช่น [1,2] กับ [2,3] ถือว่าไม่ทับ" },
      { t: "ul", c: [
...
print(erase_overlap_intervals([[1,2],[2,3]]))              # 0` },
  ...
  "lc75-p73": {
    ...
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ Minimum Number of Arrows to Burst Balloons มีลูกโป่งวางอยู่ แต่ละลูกแทนด้วย interval (ช่วง) [start, end] บนแกน x ยิงลูกศรขึ้นตรง ๆ จากตำแหน่ง x ใด ๆ ลูกศรจะเจาะลูกโป่งทุกลูกที่ interval ครอบ x นั้น (start <= x <= end) ให้หาจำนวนลูกศรน้อยที่สุดที่ทำให้ลูกโป่งแตกทุกลูก" },
      { t: "ul", c: [
