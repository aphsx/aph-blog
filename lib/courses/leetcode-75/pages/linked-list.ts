        ...
        return head`,
            ...
            { t: "h3", c: "4. จำลองการทำงาน — 1 → 3 → 4 → 7 → 1 → 2 → 6" },
            {
              ...
              rows: [
                ...
                ["รอบ 1", "1", "3", "4", "fast.next มี", "1 → 3 → 4 → 7 → 1 → 2 → 6"],
                ["รอบ 2", "3", "4", "1", "fast.next มี", "1 → 3 → 4 → 7 → 1 → 2 → 6"],
                [
                  "รอบ 3",
                  "4",
                  "7",
            ...
            { t: "h3", c: "4. จำลองการทำงาน — 5 → 4 → 2 → 1" },
            {
              ...
              rows: [
                ...
                [
                  ...
                  "slow = หัวครึ่งหลัง",
                  "ครึ่งหน้า: 5 → 4  |  ครึ่งหลัง: 2 → 1",
                ],
                [
                  "reverse ครึ่งหลัง",
                  "พลิก 2 → 1 ให้เป็น 1 → 2",
                  "prev = หัวใหม่ (ค่า 1)",
                  "ครึ่งหน้า: 5 → 4  |  ครึ่งหลังพลิก: 1 → 2",
                ],
                [
                  "บวกคู่ที่ 1",
                  "first=5 · second=1",
                  "5+1 = 6 · best = 6",
                  "5 → 4  |  1 → 2  (ยังเดินคู่ถัดไป)",
                ],
                [
                  "บวกคู่ที่ 2",
                  "first=4 · second=2",
