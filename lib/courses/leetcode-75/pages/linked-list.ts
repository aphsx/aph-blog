...
export const linkedListPages: Record<string, Page> = {
  "lc75-intro-linked-list": {
    ...
    lead: "ปูพื้นจากศูนย์ว่า linked list คืออะไร node (โหนด) กับ pointer (ตัวชี้) ทำงานยังไง traverse (เดินไล่) ไปมาบนมันแบบไหน ก่อนลงมือทำโจทย์จริง 4 ข้อ",
    group: "LeetCode 75",
    blocks: [
...
while cur:
  ...
  "lc75-p29": {
    slug: "lc75-p29",
    title: "ข้อ 29 · LC2095 Delete the Middle Node of a Linked List (ลบโหนดกลาง) 🟡",
...
print(out)   # [1, 3, 4, 1, 2, 6]` },
  ...
  "lc75-p30": {
    slug: "lc75-p30",
    title: "ข้อ 30 · LC328 Odd Even Linked List (จัดโหนดคี่-คู่) 🟡",
...
print(out)   # [1, 3, 5, 2, 4]` },
  ...
  "lc75-p31": {
    slug: "lc75-p31",
    title: "ข้อ 31 · LC206 Reverse Linked List (กลับ Linked List) 🟢",
...
print(out)   # [3, 2, 1]` },
  ...
  "lc75-p32": {
    slug: "lc75-p32",
    title: "ข้อ 32 · LC2130 Maximum Twin Sum of a Linked List (ผลรวมคู่แฝดมากสุด) 🟡",
