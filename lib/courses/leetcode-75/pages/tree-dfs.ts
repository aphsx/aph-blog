...
สมมติแต้มตามรายทางคือ: [3, 4, 1, 7, -2] และเป้าหมาย targetSum = 8`,
            },
            {
              t: "ul",
              c: [
                "**จุดเริ่มต้น:** แต้มปัจจุบัน = 0 | สมุดบันทึก: {0: 1} (เลข 0 มี 1 ครั้ง)",
                "**ก้าวที่ 1 (เจอแต้ม 3):**",
                "แต้มปัจจุบัน = 3",
                "หาอดีต: 3 - 8 = -5 (เปิดสมุดหา -5 → **ไม่เจอ**)",
                "บันทึกลงสมุด: {0: 1, 3: 1}",
                "**ก้าวที่ 2 (เจอแต้ม 4):**",
                "แต้มปัจจุบัน = 3 + 4 = 7",
                "หาอดีต: 7 - 8 = -1 (เปิดสมุดหา -1 → **ไม่เจอ**)",
                "บันทึกลงสมุด: {0: 1, 3: 1, 7: 1}",
                "**ก้าวที่ 3 (เจอแต้ม 1):**",
                "แต้มปัจจุบัน = 7 + 1 = 8",
                "หาอดีต: 8 - 8 = 0 (เปิดสมุดหา 0 → **เจอ 1 ครั้ง!** 🎉 แปลว่าช่วงตั้งแต่จุดเริ่มต้นมาถึงตรงนี้ รวมกันได้ 8 พอดี คือช่วง [3, 4, 1])",
                "บันทึกลงสมุด: {0: 1, 3: 1, 7: 1, 8: 1}",
                "**ก้าวที่ 4 (เจอแต้ม 7):**",
                "แต้มปัจจุบัน = 8 + 7 = 15",
                "หาอดีต: 15 - 8 = 7 (เปิดสมุดหา 7 → **เจอ 1 ครั้ง!** 🎉 แปลว่าจากจุดที่ได้ 7 แต้ม เดินต่อมาถึงตรงนี้ ได้เพิ่มมา 8 แต้มพอดี คือช่วง [1, 7])",
                "บันทึกลงสมุด: {0: 1, 3: 1, 7: 1, 8: 1, 15: 1}",
              ],
            },
            {
              t: "callout",
