...
export const treeDfsPages: Record<string, Page> = {
  "lc75-intro-tree-dfs": {
    ...
    title: "Binary Tree & DFS — พื้นฐาน & แนวคิด",
    lead: "รู้จัก binary tree ตั้งแต่ศูนย์ — node (โหนด), leaf (ใบ), root (ราก), คลาส TreeNode — แล้วเรียนวิธี traverse (เดินไล่) ลงลึกทีละกิ่งด้วย recursion (การเรียกตัวเอง) แบบ DFS",
    group: "LeetCode 75",
    blocks: [
...
def dfs(node):
  ...
  "lc75-p33": {
    slug: "lc75-p33",
    title: "ข้อ 33 · LC104 Maximum Depth of Binary Tree (ความลึกมากสุด) 🟢",
...
def maxDepth(root):
  ...
  "lc75-p34": {
    slug: "lc75-p34",
    title: "ข้อ 34 · LC872 Leaf-Similar Trees (ต้นไม้ใบเหมือนกัน) 🟢",
  ...
  "lc75-p35": {
    slug: "lc75-p35",
    title: "ข้อ 35 · LC1448 Count Good Nodes in Binary Tree (นับโหนดดี) 🟡",
  ...
  "lc75-p36": {
    slug: "lc75-p36",
    title: "ข้อ 36 · LC437 Path Sum III (นับ path ผลรวมเป้า) 🟡",
...
def pathSum(root, targetSum):
  ...
  "lc75-p37": {
    slug: "lc75-p37",
    title: "ข้อ 37 · LC1372 Longest ZigZag Path in a Binary Tree (ทางซิกแซกยาวสุด) 🟡",
  ...
  "lc75-p38": {
    slug: "lc75-p38",
    title: "ข้อ 38 · LC236 Lowest Common Ancestor of a Binary Tree (บรรพบุรุษร่วมต่ำสุด) 🟡",
