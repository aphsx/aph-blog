  ...
  "lc75-p33": {
    ...
    blocks: {
      th: [
        {
          t: "p",
          c: `กำหนดรูตของไบนารีทรีมาให้ ให้คืนค่าความลึกสูงสุดของต้นไม้นั้น

ความลึกสูงสุดของไบนารีทรีคือจำนวนโหนดบนเส้นทางที่ยาวที่สุดจากรูตโหนดลงไปจนถึงลีฟโหนดที่ไกลที่สุด`,
        },
        {
          t: "example",
          c: [
        ...
        },
        {
          t: "constraints",
          c: [
            "จำนวนโหนดในต้นไม้อยู่ในช่วง [0, 10^4]",
            "-100 <= Node.val <= 100",
          ],
        },
  ...
  "lc75-p34": {
    ...
    blocks: {
      th: [
        {
          t: "p",
          c: `พิจารณาลีฟทั้งหมดของไบนารีทรี เรียงตามลำดับจากซ้ายไปขวา ค่าของลีฟเหล่านั้นรวมกันเป็น leaf value sequence (ลำดับค่าลีฟ) ของต้นไม้นั้น
...
ให้คืนค่า true ก็ต่อเมื่อต้นไม้สองต้นที่กำหนดให้ (มี head nodes คือ root1 และ root2) เป็น leaf-similar`,
        },
        ...
        },
        {
          t: "constraints",
          c: [
            "จำนวนโหนดในแต่ละต้นไม้จะอยู่ในช่วง [1, 200]",
  ...
  "lc75-p35": {
    ...
    blocks: {
      th: [
        {
          t: "p",
          c: `กำหนดรูตของไบนารีทรีมาให้ โหนด X ในต้นไม้จะถูกเรียกว่า good ถ้าบนเส้นทางจากรูตไปถึง X ไม่มีโหนดใดเลยที่มีค่ามากกว่า X

ให้คืนค่าจำนวนโหนด good ทั้งหมดในไบนารีทรี`,
        },
...
โหนดรูต (3) เป็น good node เสมอ
โหนด 4 -> (3,4) คือค่ามากสุดในเส้นทางที่เริ่มจากรูต
โหนด 5 -> (3,4,5) คือค่ามากสุดในเส้นทาง
โหนด 3 -> (3,1,3) คือค่ามากสุดในเส้นทาง`,
            },
            {
              input: "root = [3,3,null,4,2]",
              output: "3",
              explain:
                'โหนด 2 -> (3, 3, 2) ไม่ใช่ good node เพราะมีค่า "3" ที่สูงกว่ามันอยู่ก่อนหน้า',
            },
            {
              input: "root = [1]",
              output: "1",
              explain: "โหนดรูตถือเป็น good node",
            },
          ],
        },
        {
          t: "constraints",
          c: [
            "จำนวนโหนดในไบนารีทรีอยู่ในช่วง [1, 10^5]",
            "ค่าของแต่ละโหนดอยู่ในช่วง [-10^4, 10^4]",
          ],
        },
  ...
  "lc75-p36": {
    ...
    blocks: {
      th: [
        {
          t: "p",
          c: `กำหนดรูตของไบนารีทรีและจำนวนเต็ม targetSum มาให้ ให้คืนค่าจำนวนพาธที่ผลรวมของค่าตามเส้นทางเท่ากับ targetSum

พาธไม่จำเป็นต้องเริ่มหรือจบที่รูตหรือลีฟ แต่ต้องเดินลงล่างเท่านั้น (คือเดินจากโหนดแม่ไปยังโหนดลูกเท่านั้น)`,
        },
        {
          t: "example",
          c: [
        ...
        },
        {
          t: "constraints",
          c: [
            "จำนวนโหนดในต้นไม้อยู่ในช่วง [0, 1000]",
            "-10^9 <= Node.val <= 10^9",
            "-1000 <= targetSum <= 1000",
          ],
        },
  ...
  "lc75-p37": {
    ...
    blocks: {
      th: [
        {
          t: "p",
          c: `คุณได้รับรูตของไบนารีทรีมาให้

ZigZag path ของไบนารีทรีถูกนิยามดังนี้:
- เลือกโหนดใด ๆ ในไบนารีทรีและทิศทาง (ขวาหรือซ้าย)
- ถ้าทิศทางปัจจุบันคือขวา ให้ก้าวไปที่โหนดลูกขวาของโหนดปัจจุบัน ถ้าไม่ใช่ ให้ก้าวไปที่โหนดลูกซ้าย
- เปลี่ยนทิศทางจากขวาเป็นซ้าย หรือจากซ้ายเป็นขวา
- ทำขั้นตอนที่สองและสามซ้ำไปเรื่อย ๆ จนกว่าจะก้าวต่อไปในต้นไม้ไม่ได้

ความยาวของซิกแซกถูกนิยามว่าเป็นจำนวนโหนดที่เยี่ยมชมลบ 1 (โหนดเดี่ยว ๆ มีความยาว 0)

ให้คืนค่า ZigZag path ที่ยาวที่สุดที่อยู่ในต้นไม้นั้น`,
        },
        {
          t: "example",
          c: [
        ...
        },
        {
          t: "constraints",
          c: [
            "จำนวนโหนดในต้นไม้อยู่ในช่วง [1, 5 * 10^4]",
            "1 <= Node.val <= 100",
          ],
        },
          ...
          c: [
            ...
            },
            {
              ...
              c: [
                ...
                "**ห้ามเดินทิศเดิมซ้ำ:** ถ้าก้าวที่แล้วเดิน **\"ซ้าย\"** ก้าวนี้ต้องเดิน **\"ขวา\"** เท่านั้น หากเดินซ้ายซ้ำ เส้นทางเดิมจะจบลงทันที แต่ก้าวซ้ำนั้นจะนับเป็น **\"ก้าวที่ 1 ของเส้นทางใหม่\"**",
        ...
        O`,
            ...
            { t: "h3", c: "2. เครื่องมือที่เลือกใช้ & การออกแบบสถานะ (State Design)" },
            {
              t: "ul",
              c: [
                "**DFS (Depth-First Search):** เดินท่องลงไปตามกิ่งก้านของต้นไม้จนสุดทาง",
                "**State Passing (ส่งค่าสถานะผ่าน Parameter):** ส่งข้อมูลติดตัวไปด้วยขณะเดินลงไป ได้แก่ `direction` (บอกว่าก้าวที่แล้วเดินมาทางไหน `'left'` หรือ `'right'`) และ `length` (บอกว่าตอนนี้สะสมความยาว ZigZag ได้กี่ก้าวแล้ว)",
              ],
            },
            ...
            },
            {
              t: "ol",
              c: [
                "**ถ้าก้าวไปใน \"ทิศตรงข้าม\" กับก้าวที่แล้ว (ได้ ZigZag!):** ความยาวสะสมจะเพิ่มขึ้นเป็น `length + 1`",
                "**ถ้าก้าวไปใน \"ทิศเดิม\" ซ้ำกับก้าวที่แล้ว (ZigZag ขาด!):** เส้นทางเดิมจบลงทันที แต่ก้าวใหม่นี้จะถูกนับเป็น **\"ก้าวที่ 1 ของการเริ่มนับ ZigZag เส้นใหม่\"** ทันที ความยาวจึง **\"รีเซ็ตเป็น 1\"** (ไม่ใช่ 0 เพราะก้าวลงมาแล้ว 1 ก้าว)",
              ],
            },

            { t: "h3", c: "4. ชำแหละไวยากรณ์ ตรรกะโค้ด และ Argument อย่างละเอียด (Line-by-Line Breakdown)" },
            {
              t: "code",
              lang: "python",
              label: "ส่วนที่ 1: ประกาศคลาสและตัวแปรสะสมค่า",
              c: `class Solution:
    def longestZigZag(self, root: Optional[TreeNode]) -> int:
        self.max_len = 0`,
            ...
            {
              t: "callout",
              title: "ทำไมต้องประกาศ `self.max_len = 0`?",
              c: "ประกาศตัวแปรระดับ Class Instance (`self.max_len`) เป็น **Global Counter** สำหรับการทำงานครั้งนี้ เพราะ DFS จะแตกกิ่งลงไปลึกเรื่อยๆ การใช้ `self.` ช่วยให้ฟังก์ชันย่อย `dfs` ด้านในเข้าถึงและอัปเดตค่าความยาวที่ยาวที่สุดเท่าที่เคยเจอตลอดทั้งต้นไม้ได้ทันที โดยไม่ต้องส่งผลลัพธ์ย้อนกลับผ่าน `return` (หมายเหตุ Edge Case: หาก Tree มีโหนดเดียว จะไม่มีเส้นเชื่อม (Edge) เลย ความยาว ZigZag เป็น 0 ซึ่งค่าเริ่มต้น 0 รองรับกรณีนี้พอดี)",
            },
            {
              t: "code",
              lang: "python",
              label: "ส่วนที่ 2: นิยามฟังก์ชัน DFS และ Parameters",
              c: `        def dfs(node, direction, length):`,
            },
            {
              t: "ul",
              c: [
                "`node`: **โหนดปัจจุบัน** ที่ DFS กำลังยืนอยู่ (ประเภท `TreeNode` หรือ `None`)",
                "`direction`: **ทิศทางที่ใช้เดินมาจากโหนดแม่** เพื่อเข้าสู่โหนดปัจจุบัน ส่งค่าเป็น String คือ `'left'` (เดินซ้ายมา) หรือ `'right'` (เดินขวามา)",
                "`length`: **จำนวนก้าวสะสม** (จำนวน Edge) ของ ZigZag Path ที่ทำได้สำเร็จมาจนถึงโหนดปัจจุบัน",
              ],
            },
            {
              t: "code",
              lang: "python",
              label: "ส่วนที่ 3: Base Case และการบันทึกค่าสูงสุด",
              c: `            if not node:
                return
            ...
            {
              t: "callout",
              title: "ทำไมต้องมี `if not node: return`?",
              c: "นี่คือ **Base Case (จุดหยุดการทำงาน)** ของ Recursion เมื่อ DFS เดินเลยโหนดปลายทาง (Leaf Node) ลงไปเจอ `None` (ว่างเปล่า) แสดงว่าตกขอบต้นไม้แล้ว จึงสั่ง `return` เพื่อหยุดและถอยกลับ (Backtrack) ไปทำงานที่กิ่งอื่นต่อ",
            },
            {
              t: "callout",
              title: "ทำไมต้องอัปเดต `self.max_len = max(self.max_len, length)` ตรงนี้?",
              c: "เมื่อ DFS เดินเข้ามาถึงโหนดที่มีอยู่จริง (`node` ไม่เป็น `None`) แสดงว่าก้าวสะสมความยาว `length` ที่ส่งเข้ามานั้นเกิดขึ้นสำเร็จแล้ว บรรทัดนี้จะเปรียบเทียบค่า `length` ปัจจุบันกับค่าสูงสุดเท่าที่เคยเจอมา (`self.max_len`) ถ้า `length` ใหม่ยาวกว่า ก็จะบันทึกทับค่าเดิมทันที",
            },
            {
              t: "code",
              lang: "python",
              label: "ส่วนที่ 4: กรณีเดินมาจากทิศ \"ซ้าย\"",
              c: `            if direction == 'left':
                # 1. เดินซ้ายมา -> ก้าวไปขวาต่อ (ZigZag สำเร็จ)
                dfs(node.right, 'right', length + 1)

                # 2. เดินซ้ายมา -> แต่ดันเดินซ้ายซ้ำ (ZigZag ขาด)
                dfs(node.left, 'left', 1)`,
            },
            {
              t: "callout",
              title: "ชำแหละ `dfs(node.right, 'right', length + 1)`",
              c: "ก้าวที่แล้วเดินมาทาง \"ซ้าย\" การเดินไปทาง \"ขวา\" ในก้าวนี้จึงเป็นการสลับทิศทางที่ถูกต้องตามกฎ ZigZag — ส่งโหนดลูกทางขวา `node.right`, บอกทิศทางใหม่เป็น `'right'`, และบวกความยาวเพิ่มอีก 1 ก้าวเป็น `length + 1`",
            },
            {
              t: "callout",
              title: "ชำแหละ `dfs(node.left, 'left', 1)`",
              c: "แม้การก้าวไปทาง \"ซ้าย\" จะผิดกฎ ZigZag ต่อจากเส้นเดิม แต่โหนดปัจจุบัน (`node`) สามารถ **\"เริ่มต้นนับเส้นทางใหม่\"** โดยใช้การก้าวลงซ้ายนี้เป็นก้าวแรกได้ — ส่ง `node.left`, ทิศทาง `'left'`, และรีเซ็ตความยาวเป็น `1` (ทำไมไม่ใช่ 0? เพราะการก้าวลงไปที่ `node.left` ครั้งนี้นับเป็น **\"ก้าวแรก (Edge ที่ 1)\"** ของการเริ่ม ZigZag เส้นใหม่ทันที)",
            },
            {
              t: "code",
              lang: "python",
              label: "ส่วนที่ 5: กรณีเดินมาจากทิศ \"ขวา\"",
              c: `            elif direction == 'right':
                # 1. เดินขวามา -> ก้าวไปซ้ายต่อ (ZigZag สำเร็จ)
                dfs(node.left, 'left', length + 1)

                # 2. เดินขวามา -> แต่ดันเดินขวาซ้ำ (ZigZag ขาด)
                dfs(node.right, 'right', 1)`,
            },
            {
              t: "callout",
              title: "ชำแหละ `dfs(node.left, 'left', length + 1)`",
              c: "ก้าวที่แล้วเดินมาทาง \"ขวา\" การเดินไปทาง \"ซ้าย\" จึงตรงตามกฎ ZigZag — ส่งโหนดลูกทางซ้าย `node.left`, ระบุทิศทางใหม่เป็น `'left'`, และเพิ่มความยาวเป็น `length + 1`",
            },
            {
              t: "callout",
              title: "ชำแหละ `dfs(node.right, 'right', 1)`",
              c: "เดินขวาซ้ำทิศเดิม เส้นเดิมขาด จึง **รีเซ็ตความยาวเริ่มต้นนับ 1 ใหม่** สำหรับ ZigZag เส้นใหม่ที่เริ่มก้าวขวา — ส่ง `node.right`, ทิศทาง `'right'`, และความยาวสะสมเริ่มต้น `1`",
            },
            {
              t: "code",
              lang: "python",
        ...
        return self.max_len`,
            ...
            {
              t: "callout",
              title: "ทำไมต้องเรียก `dfs` สองครั้ง และข้าม `root` ไปเรียก `root.left` / `root.right` เลย?",
              c: "ตัว `root` คือ **จุดยืนเริ่มต้น (ก้าวที่ 0)** ซึ่งยังไม่มีทิศทางก่อนหน้าและยังไม่มีเส้นเชื่อม (Edge) เราจะนับเป็น \"1 ก้าว\" ได้ก็ต่อเมื่อมีการก้าวออกจาก `root` ไปยังโหนดลูกแล้วเท่านั้น จึงต้องเปิดทางเลือกทดลองก้าวออกจาก `root` ทั้ง 2 ทิศทาง: `dfs(root.left, 'left', 1)` (ลองก้าวซ้าย) และ `dfs(root.right, 'right', 1)` (ลองก้าวขวา)",
            },
            {
              t: "callout",
              title: "`return self.max_len`",
              c: "เมื่อ DFS ทำงานครบทุกกิ่งก้านทั่วทั้งต้นไม้แล้ว คืนค่าความยาว ZigZag ที่ยาวที่สุดที่บันทึกได้กลับไปเป็นคำตอบ",
            },

            { t: "h3", c: "5. Step-by-Step Walkthrough (จำลองการทำงานของ Call Stack)" },
            {
              t: "code",
              lang: "text",
              c: `        1 (Root)
        ...
        3   4
          ...
          5`,
            ...
            {
              t: "callout",
              title: "📌 การไหลของโปรแกรม (Recursion Call Stack)",
              c: "คำสั่ง `dfs` บรรทัดแรกจะถูกเรียกให้ลงไปลึกที่สุดก่อน (Depth-First) เมื่อเจอ `None` โปรแกรมจะย้อนกลับ (Backtrack) ขึ้นมาเพื่อทำงานในคำสั่ง `dfs` บรรทัดถัดไป",
            },
            {
              t: "ol",
              c: [
                "**เริ่มต้นที่ Root (1):** เรียก `dfs(root.left, 'left', 1)` → เจอ `None` (ตกขอบ สั่ง `return` ย้อนกลับ) · เรียก `dfs(root.right, 'right', 1)` → เดินไปที่ **Node 2** → อัปเดต `self.max_len = max(0, 1) = 1`",
                "**ยืนที่ Node 2 (direction='right', length=1):** ทำงานบรรทัดสลับทิศก่อน เรียก `dfs(Node 3, 'left', length=1+1=2)` (มุ่งหน้าไป Node 3 ทันที)",
                "**ยืนที่ Node 3 (direction='left', length=2):** อัปเดต `self.max_len = max(1, 2) = 2` · เรียกซ้าย/ขวาเจอ `None` ทั้งคู่ → จบกิ่ง ย้อนกลับ (Backtrack) ขึ้นไปที่ **Node 2** เพื่อทำคำสั่งบรรทัดถัดไป",
                "**กลับมายืนที่ Node 2 (ทำงานบรรทัดทิศซ้ำต่อ):** เรียก `dfs(Node 4, 'right', length=1)` (รีเซ็ตนับ 1 และมุ่งหน้าไป Node 4)",
                "**ยืนที่ Node 4 (direction='right', length=1):** `self.max_len` ยังคงเป็น 2 (เพราะ `max(2, 1) = 2`) · ทำงานบรรทัดสลับทิศก่อน เรียก `dfs(Node 5, 'left', length=1+1=2)`",
                "**ยืนที่ Node 5 (direction='left', length=2):** `self.max_len = max(2, 2) = 2` · ซ้าย/ขวา เป็น `None` ทั้งคู่ → จบกิ่ง ย้อนกลับขึ้นไปตาม Call Stack จนครบทุกโหนด",
              ],
            },
            {
              t: "callout",
...
class Solution:
    def longestZigZag(self, root: Optional[TreeNode]) -> int:
        # ตัวแปรระดับ Class เอาไว้เก็บความยาว ZigZag ที่ยาวที่สุดตลอดการท่องต้นไม้
        self.max_len = 0

        def dfs(node, direction, length):
            # Base Case: ถ้าเดินตกขอบต้นไม้ (เจอ None)
            if not node:
                return

            # ทุกครั้งที่เจอโหนดที่มีอยู่จริง ให้อัปเดตค่าความยาวสูงสุดทันที
            self.max_len = max(self.max_len, length)

            # กรณีที่ 1: ก้าวที่แล้วเดินมาทาง "ซ้าย"
            if direction == 'left':
                # 1. เดินสลับทิศไปทางขวา -> ZigZag สำเร็จ (เพิ่มความยาวเป็น length + 1)
                dfs(node.right, 'right', length + 1)
                # 2. เดินซ้ำทิศไปทางซ้าย -> ZigZag ขาด (เริ่มนับเส้นใหม่ ก้าวนี้คือความยาว 1)
                dfs(node.left, 'left', 1)

            # กรณีที่ 2: ก้าวที่แล้วเดินมาทาง "ขวา"
            elif direction == 'right':
                # 1. เดินสลับทิศไปทางซ้าย -> ZigZag สำเร็จ (เพิ่มความยาวเป็น length + 1)
                dfs(node.left, 'left', length + 1)
                # 2. เดินซ้ำทิศไปทางขวา -> ZigZag ขาด (เริ่มนับเส้นใหม่ ก้าวนี้คือความยาว 1)
                dfs(node.right, 'right', 1)
        ...
        return self.max_len`,
            ...
            { t: "h3", c: "7. Complexity Analysis (วิเคราะห์ประสิทธิภาพ)" },
            {
              t: "ul",
              c: [
                "**Time Complexity: O(N)** — เพราะ DFS จะท่องผ่านทุกโหนด (N) ในต้นไม้เพียงครั้งเดียว",
                "**Space Complexity: O(N)** — ใช้หน่วยความจำใน Call Stack ตามความสูงของต้นไม้ ซึ่งกรณีแย่ที่สุด (Skewed Tree หรือต้นไม้เรียงเป็นเส้นตรง) จะใช้พื้นที่ O(N)",
              ],
            },

            {
              t: "callout",
              title: "💡 สรุป pattern",
              c: "โจทย์ข้อนี้คือจุดสูงสุดของการโชว์กึ๋นเรื่อง **\"การส่งต่อสถานะ (State Passing)\"** ใน Tree DFS — พกทิศ + ความยาว สลับทิศก็ต่อ สวนทางก็รีเซ็ตเป็น 1",
            },
          ],
        },
      ],
  ...
  "lc75-p38": {
    ...
    blocks: {
      th: [
        {
          t: "p",
          c: `กำหนดไบนารีทรีมาให้ ให้หา lowest common ancestor (LCA) ของโหนดสองตัวที่กำหนดในต้นไม้นั้น

ตามนิยามของ LCA บน Wikipedia: “lowest common ancestor ถูกนิยามระหว่างโหนด p และ q ว่าเป็นโหนดที่ต่ำที่สุดใน T ซึ่งมีทั้ง p และ q เป็นลูกหลาน (โดยอนุญาตให้โหนดหนึ่งเป็นลูกหลานของตัวเองได้)”`,
        },
        {
          t: "example",
          c: [
            {
              ...
              output: "3",
              explain: "LCA ของโหนด 5 และ 1 คือ 3",
            },
            {
              input: "root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 4",
              output: "5",
              explain:
                "LCA ของโหนด 5 และ 4 คือ 5 เนื่องจากโหนดหนึ่งสามารถเป็นลูกหลานของตัวเองได้ตามนิยามของ LCA",
            },
            {
        ...
        },
        {
          t: "constraints",
          c: [
            "จำนวนโหนดในต้นไม้อยู่ในช่วง [2, 10^5]",
            "-10^9 <= Node.val <= 10^9",
...

        {
          ...
          c: [
            {
              t: "p",
              c: "โจทย์ให้ Binary Tree กับโหนดเป้าหมายสองตัว p และ q มา แล้วถามหา **Lowest Common Ancestor (บรรพบุรุษร่วมที่ต่ำที่สุด)** — ข้อนี้ต่างจากข้อก่อนหน้าที่พกข้อมูลลงไปหาลูก (top-down) เพราะเราต้อง **รอฟังรายงานจากลูกส่งกลับขึ้นมา (bottom-up)** ครับ",
            },

            { t: "h3", c: "1. Pattern Recognition (วิธีมองโจทย์ให้ออก)" },
            {
              t: "p",
              c: "โจทย์กำหนด Binary Tree และโหนดเป้าหมาย 2 โหนด คือ `p` และ `q` มาให้ โดยต้องการหา **Lowest Common Ancestor (LCA)** หรือ **\"บรรพบุรุษร่วมที่อยู่ลึกที่สุด\"** ของโหนดทั้งสอง",
            },
            {
              t: "p",
              c: "**กฎการหา LCA:**",
            },
            {
              t: "ul",
              c: [
                "**บรรพบุรุษร่วม (Common Ancestor):** คือโหนดที่เป็นหัวหน้า/บรรพบุรุษของทั้ง `p` และ `q`",
                "**ลึกที่สุด (Lowest / Deepest):** หากมีบรรพบุรุษร่วมหลายตัว ให้เลือกตัวที่อยู่ **ลึกที่สุด** (ไกลจาก Root มากที่สุด หรือใกล้ `p` กับ `q` มากที่สุด)",
                "**โหนดสามารถเป็นบรรพบุรุษของตัวเองได้:** หาก `q` อยู่ใต้กิ่งก้านของ `p` ตัวโหนด `p` เองนั่นแหละคือ LCA",
              ],
            },
            {
              t: "code",
              lang: "text",
              c: `               3  <-- บรรพบุรุษร่วม (แต่อยู่สูง)
             /   \\
            5     1
           / \\   / \\
          6   2 0   8
...
ตัวอย่างที่ 1: หา LCA ของ p = 5 และ q = 1
-> ตอบ 3 (เพราะ 3 เป็นจุดตัดเดียวที่คุมทั้ง 5 และ 1)

ตัวอย่างที่ 2: หา LCA ของ p = 5 และ q = 4
-> ตอบ 5 (เพราะ 4 อยู่ใต้ 5 ดังนั้น 5 จึงเป็น LCA ของตัวเองและ 4)`,
            },

            { t: "h3", c: "2. เครื่องมือที่เลือกใช้ & วิธีการส่งค่ากลับ (Bottom-Up DFS)" },
            {
              t: "ul",
              c: [
                "**DFS แบบ Bottom-Up (Post-order Traversal):** เดินท่องลงไปให้สุดกิ่งก่อน แล้ว **ส่งค่าคำตอบย้อนกลับขึ้นมาจากล่างขึ้นบน**",
                "**แนวคิดการส่งค่า (Return Values):** ถ้ากิ่งนั้น **เจอ `p` หรือ `q`** ให้ส่งโหนดนั้นกลับขึ้นไป · ถ้ากิ่งนั้น **ไม่เจออะไรเลย** ให้ส่ง `None` กลับขึ้นไป",
              ],
            },
            ...
            {
              t: "p",
              c: "เมื่อเราอยู่ที่โหนดใดโหนดหนึ่ง แล้วได้รับผลลัพธ์ย้อนกลับมาจากลูกฝั่งซ้าย (`left`) และลูกฝั่งขวา (`right`):",
            },
            {
              t: "code",
              lang: "text",
              c: `                       โหนดปัจจุบัน (node)
                           /        \\
                          /          \\
                ผลลัพธ์จากฝั่งซ้าย      ผลลัพธ์จากฝั่งขวา
                    (left)                 (right)`,
            },
            {
              t: "p",
              c: "**กฎ 3 ข้อในการตัดสินใจส่งค่าขึ้นไป:**",
            },
            {
              t: "ol",
              c: [
                "**ถ้าเจอทั้งสองฝั่ง (`left` มีค่า AND `right` มีค่า):** แสดงว่าโหนดปัจจุบันคือ **\"จุดตัด/บรรพบุรุษร่วม\"** ที่เจอกิ่งหนึ่งมี `p` และอีกกิ่งหนึ่งมี `q` โหนดปัจจุบันจึงเป็น **LCA** ทันที → ส่ง `node` ปัจจุบันกลับขึ้นไป! 🎉",
                "**ถ้าเจอแค่ฝั่งเดียว (`left` มีค่า OR `right` มีค่า):** แสดงว่าทั้ง `p` และ `q` อาจจะซ่อนอยู่ในฝั่งนั้นทั้งคู่ หรือเจอแค่โหนดใดโหนดหนึ่ง → ส่งฝั่งที่มีค่าขึ้นไปต่อ",
                "**ถ้าไม่เจอทั้งสองฝั่ง (`left` เป็น None AND `right` เป็น None):** แสดงว่าใต้กิ่งนี้ไม่มีทั้ง `p` และ `q` → ส่ง `None` กลับขึ้นไป",
              ],
            },
            ...
            { t: "h3", c: "4. ชำแหละไวยากรณ์ ตรรกะโค้ด และ Argument อย่างละเอียด (Line-by-Line Breakdown)" },
            {
              t: "code",
              lang: "python",
              label: "ส่วนที่ 1: นิยามฟังก์ชันและ Base Cases",
              c: `class Solution:
    def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
        # Base Case 1: เดินตกขอบต้นไม้
        if not root:
            return None

        # Base Case 2: เจอโหนดเป้าหมาย (p หรือ q)
        if root == p or root == q:
            return root`,
            },
            {
              t: "callout",
              title: "ทำไมต้องมี `if not root: return None`?",
              c: "เมื่อ DFS เดินลงไปจนเจอ `None` (ตกขอบต้นไม้) แสดงว่ากิ่งนี้ไม่มีโหนดอยู่เลย ให้ส่ง `None` กลับขึ้นไปบอกโหนดแม่",
            },
            {
              t: "callout",
              title: "ทำไมต้องมี `if root == p or root == q: return root`?",
              c: "เมื่อเดินมาเจอโหนดที่เป็น `p` หรือ `q` ตัวใดตัวหนึ่ง ไม่จำเป็นต้องเดินลึกลงไปใต้นั้นอีกแล้ว ให้ส่งตัวมันเอง (`root`) กลับขึ้นไปบอกโหนดแม่ทันที — **หมายเหตุสำคัญ:** ถึงแม้โหนดเป้าหมายอีกตัวจะซ่อนอยู่ใต้นั้น โหนดที่เราเพิ่งเจอนี้ก็จะเป็น LCA โดยอัตโนมัติอยู่ดี ตามกฎที่โหนดเป็นบรรพบุรุษของตัวเองได้",
            },
            {
              t: "code",
              lang: "python",
              label: "ส่วนที่ 2: การสั่ง DFS ลึกลงไปทั้งสองฝั่ง (Recursion Step)",
              c: `        left = self.lowestCommonAncestor(root.left, p, q)
        right = self.lowestCommonAncestor(root.right, p, q)`,
            },
            {
              t: "callout",
              title: "ทำไมต้องสั่งทั้ง `root.left` และ `root.right`?",
              c: "เพื่อให้ DFS แตกกิ่งลงไปค้นหา `p` และ `q` ทั้งในฝั่งซ้ายและฝั่งขวาของโหนดปัจจุบัน",
            },
            {
              t: "ul",
              c: [
                "`left`: สิ่งที่ฝั่งซ้ายส่งกลับขึ้นมา (จะเป็น `TreeNode` หากเจอ `p`/`q`/LCA หรือเป็น `None` หากไม่เจอ)",
                "`right`: สิ่งที่ฝั่งขวาส่งกลับขึ้นมา",
              ],
            },
            {
              t: "code",
        ...
        return left if left else right`,
            ...
            {
              t: "callout",
              title: "บรรทัดที่ 1: `if left and right: return root`",
              c: "**เหตุผล:** หากฝั่งซ้าย (`left`) คืนค่าโหนดกลับมา AND ฝั่งขวา (`right`) ก็คืนค่าโหนดกลับมาเช่นกัน หมายความว่า `p` อยู่ฝั่งหนึ่ง และ `q` อยู่อีกฝั่งหนึ่ง — **ผลลัพธ์:** โหนดปัจจุบัน (`root`) คือ **จุดเชื่อมบรรพบุรุษร่วม (LCA)** จึงส่ง `root` ปัจจุบันกลับขึ้นไป",
            },
            {
              t: "callout",
              title: "บรรทัดที่ 2: `return left if left else right`",
              c: "**เหตุผล:** รวบตรรกะอีก 2 กรณีเข้าด้วยกัน — (1) ถ้าเจอแค่ฝั่งเดียว (เช่น `left` มีค่า แต่ `right` เป็น `None`) → ส่ง `left` ขึ้นไปต่อ (2) ถ้าไม่เจอเลยทั้งสองฝั่ง (`left` เป็น `None` และ `right` เป็น `None`) → Expression นี้จะคืนค่า `right` ซึ่งก็คือ `None` กลับขึ้นไปตามปกติ",
            },

            { t: "h3", c: "5. Step-by-Step Walkthrough (จำลองการทำงานของ Call Stack)" },
            {
              t: "p",
              c: "กำหนดต้นไม้ตัวอย่าง และค้นหา LCA ของ `p = 5` และ `q = 4`:",
            },
            {
              t: "code",
              lang: "text",
          ...
          6   4`,
            ...
            {
              t: "callout",
              title: "📌 การไหลของโปรแกรม",
              c: "DFS จะลงซ้ายสุดก่อน แล้วค่อยๆ คืนค่าขึ้นมาจากล่างขึ้นบน",
            },
            {
              t: "ol",
              c: [
                "**ยืนที่ Node 3:** สั่ง DFS ลงฝั่งซ้ายไปที่ **Node 5**",
                "**ยืนที่ Node 5:** ตรงกับเงื่อนไข `if root == p` (เจอ 5!) → **สั่ง `return Node 5` กลับขึ้นไปที่ Node 3 ทันที!** *(ไม่ต้องเสียเวลาลงไปสแกน 6 หรือ 4)*",
                "**กลับมายืนที่ Node 3:** ได้รับผลลัพธ์ฝั่งซ้าย: `left = Node 5` · สั่ง DFS ลงฝั่งขวาไปที่ **Node 1**",
                "**ยืนที่ Node 1:** สแกนซ้าย/ขวา ไม่เจอทั้ง `p` และ `q` → ส่ง `return None` กลับขึ้นมา · ได้รับผลลัพธ์ฝั่งขวา: `right = None`",
                "**ประมวลผลที่ Node 3 (Root):** `left = Node 5`, `right = None` → เข้าเงื่อนไข `return left if left else right` → **ตอบ Node 5** เป็นคำตอบสุดท้าย! 🎉",
              ],
            },
...
class Solution:
    def lowestCommonAncestor(self, root: 'TreeNode', p: 'TreeNode', q: 'TreeNode') -> 'TreeNode':
        # Base Case 1: ถ้าตกขอบต้นไม้ (None)
        if not root:
            return None

        # Base Case 2: ถ้าเจอโหนด p หรือ q
        if root == p or root == q:
            return root

        # Bottom-Up DFS: สแกนกิ่งซ้ายและกิ่งขวา
        left = self.lowestCommonAncestor(root.left, p, q)
        right = self.lowestCommonAncestor(root.right, p, q)

        # กรณีที่ 1: ถ้าเจอเป้าหมายจากทั้งกิ่งซ้ายและกิ่งขวา -> โหนดนี้คือ LCA
        if left and right:
            return root

        # กรณีที่ 2 & 3: ส่งฝั่งที่เจอขึ้นไปต่อ (หรือส่ง None ถ้าไม่เจอทั้งคู่)
        return left if left else right`,
            },
            ...
            { t: "h3", c: "7. Complexity Analysis (วิเคราะห์ประสิทธิภาพ)" },
            {
              t: "ul",
              c: [
                "**Time Complexity: O(N)** — ในกรณีแย่ที่สุด DFS จะต้องเดินทางผ่านทุกโหนดในต้นไม้ (N) เพียง 1 ครั้ง",
                "**Space Complexity: O(N)** — ใช้พื้นที่ Call Stack ตามความสูงของต้นไม้ ซึ่งกรณีแย่ที่สุด (Skewed Tree หรือต้นไม้เรียงเป็นเส้นตรง) จะใช้พื้นที่เท่ากับ O(N)",
              ],
            },

            {
              t: "callout",
              title: "💡 สรุป pattern",
              c: "postorder รายงานขึ้นมา: ให้ลูกสองฝั่งส่งสัญญาณว่าเจอเป้าหมายหรือไม่ แล้วโหนดที่ได้สัญญาณจากทั้งสองฝั่งพร้อมกันคือจุดบรรจบ (LCA) — ใช้กับโจทย์หา ancestor / จุดตัดได้ทั่วไป",
            },
          ],
        },
      ],
