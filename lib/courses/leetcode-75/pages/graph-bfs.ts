...
for dr, dc in directions:
  ...
  "lc75-p47": {
    slug: "lc75-p47",
    title: "ข้อ 47 · LC1926 Nearest Exit from Entrance in Maze (ทางออกใกล้สุดในเขาวงกต) 🟡",
    lead: "โจทย์ถามก้าวน้อยสุด = สัญญาณ BFS เก็บ steps ไปกับพิกัดใน queue ช่องติดขอบช่องแรกคือคำตอบ",
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ Nearest Exit from Entrance in Maze: ให้ grid (ตาราง) maze ที่ช่อง . คือทางเดินได้ และ + คือกำแพง พร้อมตำแหน่งทางเข้า entrance = [row, col] ให้หาจำนวนก้าว (steps) น้อยที่สุดที่จะเดินจากทางเข้าไปถึง exit (ทางออก) โดย exit คือช่องว่างที่อยู่ ติดขอบ grid (แถวบนสุด ล่างสุด คอลัมน์ซ้ายสุด ขวาสุด) และต้องไม่ใช่ช่องทางเข้าเอง เดินได้ 4 ทิศ ถ้าไปถึง exit ไม่ได้เลยให้ return (คืน) -1" },
      { t: "ul", c: [
...
print(nearest_exit(maze, [1, 2]))            # 1` },
  ...
  "lc75-p48": {
    slug: "lc75-p48",
    title: "ข้อ 48 · LC994 Rotting Oranges (ส้มเน่า) 🟡",
    lead: "multi-source BFS โยนส้มเน่าทุกลูกเข้า queue พร้อมกัน แผ่ทีละชั้นนับเป็นนาที ปิดท้ายเช็คส้มสดที่เหลือ",
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ Rotting Oranges: ให้ grid (ตาราง) ที่แต่ละช่องเป็น 0 (ว่าง) 1 (ส้มสด) หรือ 2 (ส้มเน่า) ทุก ๆ หนึ่งนาที ส้มเน่าจะทำให้ส้มสดที่อยู่ ติดกัน 4 ทิศ เน่าตามไปด้วย ให้หาว่าใช้เวลากี่นาทีจนไม่เหลือส้มสดเลย ถ้ามีส้มสดที่ไม่มีวันเน่า (ไม่มีส้มเน่าเข้าถึง) ให้ return (คืน) -1" },
      { t: "ul", c: [
