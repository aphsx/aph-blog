...
export const fundamentalsPages: Record<string, Page> = {
  "lc75-bigo": {
    slug: "lc75-bigo",
    title: { th: "Big-O — วัดว่าโค้ดเร็วหรือช้า", en: "" },
    lead: { th: "ก่อนแตะโจทย์ข้อแรก ต้องรู้จัก Big-O ก่อน — วิธีบอกว่า \"ถ้าข้อมูลใหญ่ขึ้น โค้ดเราจะช้าลงแค่ไหน\" ทุกเฉลยในคอร์สนี้จะพูดถึงมัน", en: "" },
    group: "เริ่มต้น",
    blocks: {
      th: [
...
for x in nums:          # + n  ->  ตัดทิ้ง เหลือ O(n^2)
  ...
  "lc75-pick": {
    slug: "lc75-pick",
    title: { th: "เจอโจทย์ใหม่ จะรู้ได้ยังไงว่าใช้หมวดไหน", en: "" },
    lead: { th: "คอร์สนี้มี 22 หมวด แต่ละหมวดสอนแยกกัน หน้านี้คือส่วนที่หายไป — วิธีตัดสินใจว่าโจทย์ที่ไม่เคยเห็นควรหยิบหมวดไหนมาใช้", en: "" },
    group: "เริ่มต้น",
    blocks: {
      th: [
