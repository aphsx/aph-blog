...
print(next_greater([2, 1, 2, 4, 3]))  # [3, 2, 3, -1, -1]` },
  ...
  "lc75-p74": {
    ...
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "Daily Temperatures: มี array (ลิสต์) อุณหภูมิรายวัน temperatures ให้คืน array answer โดย answer[i] คือต้องรออีกกี่วันจึงจะเจอวันที่อุณหภูมิสูงกว่าวันที่ i ถ้าไม่มีวันไหนร้อนกว่าเลยให้เป็น 0" },
      { t: "ul", c: [
...
print(daily_temperatures([30, 60, 90]))      # [1, 1, 0]` },
  ...
  "lc75-p75": {
    ...
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "Online Stock Span: ออกแบบ class StockSpanner ที่รับราคาหุ้นรายวันเข้ามาทีละวันผ่าน method (เมท็อด) next(price) แล้ว return span (ช่วง) ของราคาวันนี้ ซึ่งหมายถึงจำนวนวันติดต่อกัน (นับรวมวันนี้ ย้อนไปทางอดีต) ที่ราคาน้อยกว่าหรือเท่ากับราคาวันนี้" },
      { t: "ul", c: [
