...
dfs(0, graph, visited)             # เริ่มจาก node 0` },
  ...
  "lc75-p43": {
    slug: "lc75-p43",
    title: "ข้อ 43 · LC841 Keys and Rooms (กุญแจกับห้อง) 🟡",
    lead: "มองห้องเป็น node กุญแจเป็น edge ทำ DFS จากห้อง 0 แล้วเช็คว่า visited ครบทุกห้องไหม",
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ (Keys and Rooms) มี n ห้องเลข 0 ถึง n-1 ตอนแรกทุกห้องล็อกหมด ยกเว้นห้อง 0 ที่เปิดอยู่ ในแต่ละห้องมีพวงกุญแจ rooms[i] เป็น list ของเลขห้องที่กุญแจในห้อง i เปิดได้ เริ่มจากห้อง 0 เราเดินเก็บกุญแจไปเปิดห้องอื่นต่อได้เรื่อย ๆ ให้ตอบว่าเราจะเข้าถึงทุกห้องได้ครบหรือไม่" },
      { t: "ul", c: [
...
False` },
  ...
  "lc75-p44": {
    slug: "lc75-p44",
    title: "ข้อ 44 · LC547 Number of Provinces (นับจำนวนจังหวัด) 🟡",
    lead: "นับ connected components iterate node ทุกตัว เจอตัวที่ยังไม่ visited คือแคว้นใหม่ แล้ว DFS กวาดให้หมด",
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ (Number of Provinces) มี n เมือง ให้ตารางสี่เหลี่ยม isConnected ขนาด n x n โดย isConnected[i][j] = 1 แปลว่าเมือง i กับ j เชื่อมกันโดยตรง ถ้าเป็น 0 คือไม่เชื่อม เมืองที่เชื่อมถึงกัน (ไม่ว่าโดยตรงหรือผ่านเมืองอื่น) นับเป็นแคว้น (province) เดียวกัน ให้นับว่ามีทั้งหมดกี่แคว้น" },
      { t: "ul", c: [
...
3` },
  ...
  "lc75-p45": {
    slug: "lc75-p45",
    title: "ข้อ 45 · LC1466 Reorder Routes to Make All Paths Lead to the City Zero (กลับทิศถนนไปเมือง 0) 🟡",
    lead: "คิดกลับด้าน เดิน DFS จากเมือง 0 ออกไป edge ไหนชี้ตามทางที่เราเดินออก คือ edge ที่ต้องกลับทิศ",
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ (Reorder Routes to Make All Paths Lead to the City Zero) มี n เมืองเลข 0 ถึง n-1 เชื่อมกันด้วยถนน n-1 เส้นเป็นรูป tree (ต้นไม้) (ทุกเมืองถึงกันได้ถ้าไม่สนทิศ) แต่ถนนเป็นแบบ directed (มีทิศ) connections[i] = [a,b] แปลว่ามี edge (เส้นเชื่อม) จาก a ไป b ให้หาจำนวนถนนน้อยที่สุดที่ต้องกลับทิศ เพื่อให้ทุกเมืองสามารถเดินทางไปถึงเมือง 0 ได้" },
      { t: "ul", c: [
...
2` },
  ...
  "lc75-p46": {
    slug: "lc75-p46",
    title: "ข้อ 46 · LC399 Evaluate Division (คำนวณการหาร) 🟡",
    lead: "weighted graph แต่ละตัวแปรเป็น node สมการเป็น edge ที่มีค่า หา x/y ด้วย DFS คูณน้ำหนักตลอดทาง",
    group: "LeetCode 75",
    blocks: [
      { t: "p", c: "โจทย์ (Evaluate Division) ให้สมการอัตราส่วนมาชุดหนึ่ง เช่น a/b = 2.0 และ b/c = 3.0 แล้วถาม query (คำถาม) ว่าอัตราส่วนของตัวแปรคู่อื่น ๆ เป็นเท่าไร ถ้าตัวแปรไหนไม่รู้จัก หรือเชื่อมโยงกันไม่ได้ ให้ตอบ -1.0" },
      { t: "ul", c: [
