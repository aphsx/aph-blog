...
export const testingPages: Record<string, Page> = {
  ...
  "test-why": {
    slug: "test-why",
    title: { th: "ทำไมต้องเทสต์ & ประเภทของเทสต์", en: "" },
    lead: { th: "เทสต์อัตโนมัติคือตาข่ายนิรภัยที่ทำให้คุณกล้าแก้โค้ดโดยไม่กลัวพังโดยไม่รู้ตัว", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "test-pytest": {
    slug: "test-pytest",
    title: { th: "เริ่มต้นกับ pytest", en: "" },
    lead: { th: "เขียนและรันเทสต์อัตโนมัติด้วย pytest — เครื่องมือเทสต์ที่นิยมที่สุดใน Python", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "test-fixtures": {
    slug: "test-fixtures",
    title: { th: "Fixture & Parametrize", en: "" },
    lead: { th: "เตรียมข้อมูลซ้ำ ๆ ด้วย fixture และทดสอบหลายชุดข้อมูลด้วยโค้ดเดียวด้วย parametrize", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "test-mock": {
    slug: "test-mock",
    title: { th: "Mock & แยก dependency", en: "" },
    lead: { th: "เทสต์โค้ดที่พึ่งของภายนอก (API, DB, เวลา) โดยใช้ของปลอมแทน เพื่อให้เทสต์เร็วและเสถียร", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "test-tdd": {
    slug: "test-tdd",
    title: { th: "TDD & Coverage", en: "" },
    lead: { th: "เขียนเทสต์ก่อนโค้ด (Red → Green → Refactor) และวัดว่าเทสต์ครอบคลุมโค้ดแค่ไหน", en: "" },
    group: GROUP,
    blocks: {
      th: [
