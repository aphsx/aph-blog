...
export const webAppsPages: Record<string, Page> = {
  ...
  "web2-http": {
    slug: "web2-http",
    title: "HTTP เจาะลึก",
    lead: "เข้าใจ request/response, methods, status code และหลัก REST — รากฐานของทุก web API",
    group: GROUP,
    blocks: [
  ...
  "web2-framework": {
    slug: "web2-framework",
    title: "เริ่มกับ FastAPI",
    lead: "สร้าง web API ตัวแรกด้วย FastAPI — framework สมัยใหม่ที่ใช้ type hint สร้าง validation + docs ให้",
    group: GROUP,
    blocks: [
  ...
  "web2-request": {
    slug: "web2-request",
    title: "รับ Request & Validation",
    lead: "รับ query parameter และ request body พร้อมตรวจสอบข้อมูลอัตโนมัติด้วย Pydantic",
    group: GROUP,
    blocks: [
  ...
  "web2-db": {
    slug: "web2-db",
    title: "เชื่อม API กับ DB (CRUD API)",
    lead: "ต่อ API เข้ากับฐานข้อมูล (บท 9) ทำ endpoint CRUD ครบ พร้อมแยก layer ให้เทสต์ง่าย",
    group: GROUP,
    blocks: [
  ...
  "web2-auth": {
    ...
    lead: "ทำให้แอป \"รู้ว่าใครเป็นใคร\" — login, hash รหัสผ่าน, และป้องกัน endpoint ด้วย token",
    group: GROUP,
    blocks: [
  ...
  "web2-security": {
    ...
    lead: "ช่องโหว่ความปลอดภัยที่เจอบ่อย (มากกว่าแค่ SQL injection) และวิธีป้องกัน",
    group: GROUP,
    blocks: [
  ...
  "web2-project": {
    slug: "web2-project",
    title: "ประกอบ API จริง end-to-end",
    lead: "รวมทุกอย่างในบทนี้เป็น API ที่มีโครงสร้างดี ปลอดภัย และเทสต์ได้ — ตัวอย่างย่อของ capstone",
    group: GROUP,
    blocks: [
