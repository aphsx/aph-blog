...
export const overviewPages: Record<string, Page> = {
  intermediate: {
    slug: "intermediate",
    title: "เขียนโปรแกรมเชิงลึก — ภาพรวม & หลักสูตร",
    lead: "คอร์สเขียนโปรแกรมแบบลงลึก ต่อยอดจากคอร์สพื้นฐาน เจาะลึกทุกหัวข้อให้ละเอียดกว่าเดิม — โดยมี Data Structures & Algorithms เป็นหัวใจ",
