...
export const overviewPages: Record<string, Page> = {
  intermediate: {
    ...
    lead: "ต่อยอดจากพื้นฐาน สู่ระดับ mid-level ที่ทำงานจริงได้ — เน้นทักษะ programmer ทั่วไป โดยมี Data Structures & Algorithms เป็นหัวใจ",
    group: "เขียนโปรแกรมระดับกลาง",
    blocks: [
      { t: "p", c: "ถ้าคุณเขียนโปรแกรมพื้นฐานเป็นแล้ว (ตัวแปร, loop, function, list/dict, OOP เบื้องต้น) แต่ยังไม่รู้ว่า \"โค้ดในงานจริงเขาทำกันยังไง\" คอร์สนี้คือสะพานช่วงกลางที่ขาดหายไป เราจะพาคุณจากระดับพื้นฐานไปสู่ระดับ mid-level ที่ทำงานเป็นทีมและสมัครงานได้จริง" },
      ...
      { t: "h2", c: "เส้นทางทั้งหมด" },
      { t: "p", c: "คอร์สนี้คือจุดกึ่งกลางของเส้นทางสู่การเป็น software engineer:" },
      {
        t: "table",
        head: ["ขั้น", "คอร์ส", "จากระดับ → ไประดับ"],
        rows: [
          ["1", "เขียนโปรแกรมจากศูนย์", "ไม่มีพื้นฐาน → เขียนโปรแกรมพื้นฐานได้"],
          ["2", "เขียนโปรแกรมระดับกลาง (คอร์สนี้)", "พื้นฐาน → mid-level ทำงานจริงได้"],
          ["3", "SE Roadmap", "mid-level → เตรียมสัมภาษณ์ & ได้งาน"],
        ],
      },
      ...
      { t: "callout", title: "บทเด่นของคอร์ส", c: "บทที่ 10 (Data Structures & Algorithms) คือหัวใจของคอร์ส ลงลึกทั้งการเขียนเอง, การวิเคราะห์ Big-O และโจทย์ฝึก เพราะนี่คือทักษะที่ทำให้คุณเป็นโปรแกรมเมอร์ที่เก่งขึ้นและผ่านด่านสัมภาษณ์งานได้" },
