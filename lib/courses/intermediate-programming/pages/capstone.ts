...
export const capstonePages: Record<string, Page> = {
  ...
  "cap-plan": {
    slug: "cap-plan",
    title: { th: "วางแผน & ออกแบบโปรเจกต์", en: "" },
    lead: { th: "เลือกโปรเจกต์ เขียน requirement ออกแบบ data model และแตกงาน — วางแผนก่อนเขียนโค้ด", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "cap-build": {
    slug: "cap-build",
    title: { th: "สร้างทีละส่วน (ใช้ทุกอย่างที่เรียนมา)", en: "" },
    lead: { th: "ลงมือสร้างทีละ feature — โครงสร้างโปรเจกต์ + git + เทสต์ + clean code + DB + API ครบ", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "cap-quality": {
    slug: "cap-quality",
    title: { th: "คุณภาพ, เอกสาร & CI", en: "" },
    lead: { th: "ทำให้โปรเจกต์ดูเป็นมืออาชีพ: README ที่ดี, linter/formatter และ CI ที่รันเทสต์อัตโนมัติ", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "cap-deploy": {
    slug: "cap-deploy",
    title: { th: "Deploy เบื้องต้น & ไปต่อ", en: "" },
    lead: { th: "นำโปรเจกต์ขึ้นใช้งานจริง รู้จัก Docker เบื้องต้น และวางแผนเส้นทางหลังจบคอร์ส", en: "" },
    group: GROUP,
    blocks: {
      th: [
