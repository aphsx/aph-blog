...
export const gitDeepPages: Record<string, Page> = {
  ...
  "git-recap": {
    slug: "git-recap",
    title: { th: "ทบทวน Git + Mental Model", en: "" },
    lead: { th: "เข้าใจ git เป็น \"ภาพถ่าย\" ของโปรเจกต์ และ 3 พื้นที่ที่ทำให้ทุกคำสั่งง่ายขึ้น", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "git-branch": {
    slug: "git-branch",
    title: { th: "Branch & Merge", en: "" },
    lead: { th: "แยกงานเป็น \"สาย\" ของตัวเองแล้วรวมกลับ — หัวใจของการทำงานหลายฟีเจอร์/หลายคนพร้อมกัน", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "git-remote": {
    slug: "git-remote",
    title: { th: "Remote, GitHub & push/pull", en: "" },
    lead: { th: "เก็บโค้ดบนเซิร์ฟเวอร์กลาง (เช่น GitHub) แล้ว push/pull เพื่อทำงานร่วมกับคนอื่น", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "git-conflict": {
    slug: "git-conflict",
    title: { th: "Merge Conflict & Rebase", en: "" },
    lead: { th: "แก้เมื่อสองคนแก้บรรทัดเดียวกัน และเข้าใจว่า rebase ต่างจาก merge อย่างไร", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "git-workflow": {
    slug: "git-workflow",
    title: { th: "PR Workflow & commit hygiene", en: "" },
    lead: { th: "วิธีที่ทีมจริงทำงานด้วยกัน: feature branch → Pull Request → review → merge พร้อมเขียน commit ที่ดี", en: "" },
    group: GROUP,
    blocks: {
      th: [
