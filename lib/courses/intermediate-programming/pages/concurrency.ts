...
export const concurrencyPages: Record<string, Page> = {
  ...
  "async-why": {
    ...
    lead: "เข้าใจความต่างของ \"ทำสลับกัน\" กับ \"ทำพร้อมกันจริง\" และเลือกเครื่องมือให้ถูกกับงาน",
    group: GROUP,
    blocks: [
  ...
  "async-threads": {
    slug: "async-threads",
    title: "Threading & GIL",
    lead: "ทำหลายงาน I/O พร้อมกันด้วย thread — และเข้าใจว่าทำไม GIL ทำให้ thread ไม่เร่งงานคำนวณ",
    group: GROUP,
    blocks: [
  ...
  "async-process": {
    ...
    lead: "ข้ามข้อจำกัด GIL ด้วยการแยกเป็นหลาย process — สำหรับงานคำนวณหนัก (CPU-bound)",
    group: GROUP,
    blocks: [
  ...
  "async-asyncio": {
    ...
    lead: "จัดการงาน I/O จำนวนมากพร้อมกันด้วย async/await — เบาและขยายได้กว่า thread",
    group: GROUP,
    blocks: [
