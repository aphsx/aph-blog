...
export const databasesPages: Record<string, Page> = {
  ...
  "db-model": {
    slug: "db-model",
    title: { th: "Relational Model & ออกแบบตาราง", en: "" },
    lead: { th: "เข้าใจตาราง แถว คอลัมน์ key และความสัมพันธ์ — รากฐานของการออกแบบฐานข้อมูลที่ดี", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "db-sql": {
    slug: "db-sql",
    title: { th: "SQL เจาะลึก", en: "" },
    lead: { th: "ภาษาสำหรับคุยกับฐานข้อมูล — สร้าง ดึง แก้ ลบ และรวมข้อมูลข้ามตารางด้วย JOIN", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "db-advanced": {
    slug: "db-advanced",
    title: { th: "Index, Transaction & Constraint", en: "" },
    lead: { th: "ทำให้ query เร็วขึ้นด้วย index, รับประกันความถูกต้องด้วย transaction และ constraint", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "db-python": {
    slug: "db-python",
    title: { th: "เชื่อม Python กับ DB (sqlite3)", en: "" },
    lead: { th: "สั่งงานฐานข้อมูลจากโค้ด Python ด้วย sqlite3 ที่มากับ Python — และกัน SQL injection", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "db-orm": {
    slug: "db-orm",
    title: { th: "ORM (SQLAlchemy)", en: "" },
    lead: { th: "map class ของ Python เข้ากับตารางในฐานข้อมูล เขียน CRUD ด้วยโค้ด Python แทน SQL ดิบ", en: "" },
    group: GROUP,
    blocks: {
      th: [
