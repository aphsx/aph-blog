...
export const robustCodePages: Record<string, Page> = {
  ...
  "err-exceptions": {
    slug: "err-exceptions",
    title: "Exception เจาะลึก",
    lead: "จัดการข้อผิดพลาดให้ถูกวิธีด้วย try/except/else/finally — ไม่ใช่แค่ครอบ try กว้าง ๆ แล้วเงียบ",
    group: GROUP,
    blocks: [
  ...
  "err-custom": {
    slug: "err-custom",
    title: "สร้าง Exception เอง & raise",
    lead: "นิยามข้อผิดพลาดของโดเมนงานเอง เพื่อให้ผู้เรียกจับและจัดการได้ตรงจุด",
    group: GROUP,
    blocks: [
  ...
  "err-logging": {
    slug: "err-logging",
    title: "Logging (เลิก print debug)",
    lead: "บันทึกสิ่งที่โปรแกรมทำด้วย logging — ควบคุมระดับ เปิด/ปิด และเขียนลงไฟล์ได้ ต่างจาก print",
    group: GROUP,
    blocks: [
  ...
  "err-typing": {
    ...
    lead: "บอกชนิดข้อมูลในโค้ดเพื่อให้ editor และเครื่องมือช่วยจับ bug ก่อนรัน — มาตรฐานทีมสมัยใหม่",
    group: GROUP,
    blocks: [
  ...
  "err-defensive": {
    ...
    lead: "ตรวจสอบ input ที่ขอบระบบและเขียนโค้ดที่ \"พังเร็ว พังชัด\" แทนที่จะคำนวณผิดเงียบ ๆ",
    group: GROUP,
    blocks: [
