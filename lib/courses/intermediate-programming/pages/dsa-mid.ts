...
export const dsaMidPages: Record<string, Page> = {
  ...
  "dsa-choose": {
    slug: "dsa-choose",
    title: { th: "เลือกโครงสร้างให้ถูก & ทบทวน Big-O", en: "" },
    lead: { th: "เลือก data structure ให้เหมาะกับงานคือทักษะจริง — ทบทวน Big-O แล้วดูตารางเทียบ", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-stack-queue": {
    ...
    title: { th: "Stack, Queue & Deque", en: "" },
    lead: { th: "สองโครงสร้างพื้นฐาน: stack (เข้าหลังออกก่อน) และ queue (เข้าก่อนออกก่อน)", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-linked": {
    slug: "dsa-linked",
    title: { th: "Linked List", en: "" },
    lead: { th: "โครงสร้างที่แต่ละ node ชี้ไป node ถัดไป — เข้าใจ pointer และโจทย์สัมภาษณ์คลาสสิก", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-tree": {
    slug: "dsa-tree",
    title: { th: "Tree & Binary Search Tree", en: "" },
    lead: { th: "โครงสร้างลำดับชั้น และ BST ที่ค้นหาได้เร็ว O(log n) ด้วย recursion", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-heap": {
    slug: "dsa-heap",
    title: { th: "Heap & Priority Queue", en: "" },
    lead: { th: "โครงสร้างที่ดึงค่าน้อยสุด/มากสุดได้เร็ว — เจอบ่อยมากในงานจริงและสัมภาษณ์", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-hash": {
    slug: "dsa-hash",
    title: { th: "Hash Table เจาะลึก", en: "" },
    lead: { th: "ทำไม dict/set ค้นหาได้ O(1) และใช้มันแก้โจทย์จำนวนมากได้อย่างไร", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-sorting": {
    slug: "dsa-sorting",
    title: { th: "Sorting เชิงลึก", en: "" },
    lead: { th: "เข้าใจ algorithm การเรียงลำดับ ไม่ใช่แค่เรียก .sort() — merge/quick sort และการเลือกใช้", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-binary-search": {
    ...
    title: { th: "Binary Search & Variations", en: "" },
    lead: { th: "ค้นหาในข้อมูลที่เรียงแล้วด้วย O(log n) — และรูปแบบที่ดัดแปลงที่เจอบ่อย", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-twopointer": {
    slug: "dsa-twopointer",
    title: { th: "Two-Pointer & Sliding Window", en: "" },
    lead: { th: "สองเทคนิคที่เปลี่ยนโจทย์ array/string จาก O(n²) เป็น O(n) — เจอบ่อยที่สุดในการสัมภาษณ์", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-recursion": {
    slug: "dsa-recursion",
    title: { th: "Recursion ลึก & Backtracking", en: "" },
    lead: { th: "ฟังก์ชันที่เรียกตัวเอง และเทคนิค backtracking (ลองแล้วถอย) สำหรับโจทย์ค้นหาคำตอบ", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-dp": {
    slug: "dsa-dp",
    title: { th: "Dynamic Programming เบื้องต้น", en: "" },
    lead: { th: "จำผลลัพธ์ที่คำนวณแล้วเพื่อไม่คำนวณซ้ำ — เปลี่ยนโจทย์ช้าระเบิดให้เร็วขึ้นมหาศาล", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-greedy": {
    slug: "dsa-greedy",
    title: { th: "Greedy Algorithms", en: "" },
    lead: { th: "แก้ปัญหาด้วยการเลือก \"ดีที่สุดตอนนี้\" ทุกขั้น — เร็วและง่าย แต่ต้องรู้ว่าเมื่อไรใช้ไม่ได้", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dsa-graph": {
    slug: "dsa-graph",
    title: { th: "Graph & BFS/DFS", en: "" },
    lead: { th: "โครงสร้างความสัมพันธ์ (จุด-เส้น) และการท่องด้วย BFS/DFS — แผนที่ โซเชียล เส้นทาง", en: "" },
    group: GROUP,
    blocks: {
      th: [
