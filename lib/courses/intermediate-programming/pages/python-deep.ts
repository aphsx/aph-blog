...
export const pythonDeepPages: Record<string, Page> = {
  ...
  "py-comprehension": {
    ...
    title: { th: "Comprehension เจาะลึก", en: "" },
    lead: { th: "เขียน list/dict/set ในบรรทัดเดียวแบบ Pythonic — อ่านง่าย เร็ว และรู้ว่าเมื่อไรไม่ควรใช้", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "py-iter-gen": {
    slug: "py-iter-gen",
    title: { th: "Iterator & Generator (yield)", en: "" },
    lead: { th: "เข้าใจว่า for ทำงานเบื้องหลังอย่างไร และสร้างข้อมูลทีละชิ้นแบบประหยัด memory ด้วย generator", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "py-args": {
    slug: "py-args",
    title: { th: "*args, **kwargs & การ Unpack", en: "" },
    lead: { th: "เขียนฟังก์ชันที่รับ argument ได้ยืดหยุ่น และกระจายข้อมูลเข้า/ออกด้วย * และ **", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "py-hof-lambda": {
    slug: "py-hof-lambda",
    title: { th: "Lambda & Higher-Order Functions", en: "" },
    lead: { th: "มองฟังก์ชันเป็น \"ค่า\" ที่เก็บใส่ตัวแปร ส่งเข้าฟังก์ชันอื่น และคืนกลับได้", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "py-closures": {
    slug: "py-closures",
    title: { th: "Scope & Closure", en: "" },
    lead: { th: "ตัวแปรอยู่ \"ที่ไหน\" และฟังก์ชันจำค่าจาก scope แม่ได้อย่างไร — รากฐานของ decorator", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "py-decorators": {
    slug: "py-decorators",
    title: { th: "Decorator", en: "" },
    lead: { th: "เพิ่มความสามารถให้ฟังก์ชัน (เช่น จับเวลา, log, cache) โดยไม่ต้องแก้ตัวฟังก์ชันเดิม", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "py-context": {
    slug: "py-context",
    title: { th: "Context Manager (with)", en: "" },
    lead: { th: "ใช้และเขียน with เพื่อจัดการ resource (ไฟล์, connection) ให้เปิด-ปิดถูกต้องเสมอ แม้เกิด error", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "py-mutability": {
    slug: "py-mutability",
    title: { th: "Mutability, Reference & Copy", en: "" },
    lead: { th: "เข้าใจว่าตัวแปรชี้ไปที่ object อย่างไร — รากของบั๊ก Python ที่เจอบ่อยที่สุดเมื่อเริ่มเขียนจริงจัง", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "py-collections": {
    slug: "py-collections",
    title: { th: "collections & itertools", en: "" },
    lead: { th: "เครื่องมือใน standard library ที่มืออาชีพใช้ทุกวัน — เขียนน้อยลง บั๊กน้อยลง", en: "" },
    group: GROUP,
    blocks: {
      th: [
