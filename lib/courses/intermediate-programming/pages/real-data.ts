...
export const realDataPages: Record<string, Page> = {
  ...
  "data-files": {
    slug: "data-files",
    title: "อ่าน/เขียนไฟล์ & pathlib",
    lead: "อ่านและเขียนไฟล์อย่างปลอดภัยด้วย with open และจัดการ path สมัยใหม่ด้วย pathlib",
    group: GROUP,
    blocks: [
  ...
  "data-formats": {
    slug: "data-formats",
    title: "CSV & JSON",
    lead: "อ่าน/เขียนสองรูปแบบข้อมูลที่เจอบ่อยที่สุด — CSV (ตาราง) และ JSON (ภาษากลางของ API)",
    group: GROUP,
    blocks: [
  ...
  "data-regex": {
    ...
    lead: "ค้นหา แยก ตรวจสอบ และแทนที่รูปแบบในข้อความด้วย regex — ทักษะที่เจอตลอดในงานจริง",
    group: GROUP,
    blocks: [
  ...
  "data-http": {
    slug: "data-http",
    title: "เรียก API จริงด้วย requests",
    lead: "ดึงและส่งข้อมูลกับเว็บ/REST API ด้วยไลบรารี requests — ก้าวสู่การทำงานกับข้อมูลออนไลน์",
    group: GROUP,
    blocks: [
  ...
  "data-datetime": {
    slug: "data-datetime",
    title: "วันเวลา (datetime)",
    lead: "คำนวณ จัดรูป และแปลงวันเวลาอย่างถูกต้อง พร้อมหลบกับดักเรื่อง timezone",
    group: GROUP,
    blocks: [
  ...
  "data-pandas": {
    slug: "data-pandas",
    title: "รู้จัก pandas (เบื้องต้น)",
    lead: "เครื่องมือจัดการข้อมูลตารางที่ทรงพลัง — รู้จักไว้พอใช้งานได้ ก่อนลงลึกถ้าเล็งสาย Data",
    group: GROUP,
    blocks: [
