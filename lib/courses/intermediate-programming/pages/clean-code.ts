...
export const cleanCodePages: Record<string, Page> = {
  ...
  "clean-naming": {
    slug: "clean-naming",
    title: { th: "Naming, ฟังก์ชันที่ดี & Docstring", en: "" },
    lead: { th: "เขียนโค้ดให้คน \"อ่าน\" เข้าใจ ไม่ใช่แค่ให้เครื่อง \"รัน\" ได้ — เริ่มที่ชื่อและฟังก์ชัน", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "clean-principles": {
    ...
    title: { th: "DRY, KISS, YAGNI & Code Smells", en: "" },
    lead: { th: "หลักการคิดที่ทำให้โค้ดดูแลง่าย และสัญญาณเตือน (code smell) ว่าโค้ดเริ่มมีปัญหา", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "clean-solid": {
    slug: "clean-solid",
    title: { th: "SOLID 5 ข้อ", en: "" },
    lead: { th: "หลักการออกแบบ class/module 5 ข้อที่ทำให้โค้ดยืดหยุ่น แก้ง่าย และทดสอบง่าย", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "clean-refactor": {
    slug: "clean-refactor",
    title: { th: "Refactoring", en: "" },
    lead: { th: "ปรับปรุงโครงสร้างโค้ดให้ดีขึ้นโดยไม่เปลี่ยนพฤติกรรม — ทำได้อย่างปลอดภัยเมื่อมีเทสต์", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "clean-patterns": {
    slug: "clean-patterns",
    title: { th: "Design Patterns พื้นฐาน", en: "" },
    lead: { th: "วิธีแก้ปัญหาการออกแบบที่เจอซ้ำ ๆ แบบมีแบบแผน — รู้จักไว้และใช้เมื่อมันแก้ปัญหาจริง", en: "" },
    group: GROUP,
    blocks: {
      th: [
