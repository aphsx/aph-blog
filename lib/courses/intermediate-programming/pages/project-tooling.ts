...
export const projectToolingPages: Record<string, Page> = {
  ...
  "proj-modules": {
    slug: "proj-modules",
    title: { th: "Module & import", en: "" },
    lead: { th: "แยกโค้ดออกเป็นหลายไฟล์แล้วเรียกใช้กัน — ก้าวแรกของการเลิกเขียนทุกอย่างในไฟล์เดียว", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "proj-packages": {
    slug: "proj-packages",
    title: { th: "Package & โครงสร้างโฟลเดอร์", en: "" },
    lead: { th: "จัดหลาย module เป็นโฟลเดอร์ และวาง layout โปรเจกต์แบบที่ใช้กันจริง", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "proj-venv": {
    slug: "proj-venv",
    title: { th: "Virtual Environment & pip", en: "" },
    lead: { th: "แยกชุด library ของแต่ละโปรเจกต์ออกจากกัน เพื่อไม่ให้เวอร์ชันตีกัน", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "proj-cli": {
    slug: "proj-cli",
    title: { th: "สร้าง CLI ด้วย argparse", en: "" },
    lead: { th: "ทำสคริปต์ให้รับ argument จาก command line อย่างมืออาชีพ พร้อม --help อัตโนมัติ", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "proj-env": {
    slug: "proj-env",
    title: { th: "Environment Variables & Config", en: "" },
    lead: { th: "เก็บค่าตั้งค่าและ secret (เช่น API key) ไว้นอกโค้ด — ปลอดภัยและเปลี่ยนได้โดยไม่แก้โปรแกรม", en: "" },
    group: GROUP,
    blocks: {
      th: [
