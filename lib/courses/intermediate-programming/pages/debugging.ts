...
export const debuggingPages: Record<string, Page> = {
  ...
  "dbg-debugger": {
    ...
    group: GROUP,
    blocks: [
      { t: "p", c: "เมื่อโค้ดทำงานไม่เป็นไปตามคาด มือใหม่มักโรย print() ไปทั่วแล้วลบทีหลัง แต่ debugger ให้คุณ \"หยุดเวลา\" ในโปรแกรมแล้วสำรวจค่าตัวแปรทุกตัวได้ทันที breakpoint เดียวมักบอกได้มากกว่า print สิบบรรทัด — นี่คือทักษะที่แยก mid-level ออกจาก junior ชัดที่สุด" },
