...
export const debuggingPages: Record<string, Page> = {
  ...
  "dbg-debugger": {
    slug: "dbg-debugger",
    title: { th: "ใช้ Debugger จริง (pdb / VS Code)", en: "" },
    lead: { th: "เลิก debug ด้วย print อย่างเดียว — หยุดโปรแกรมแล้วเดินดู state ทีละบรรทัดด้วย debugger", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dbg-traceback": {
    slug: "dbg-traceback",
    title: { th: "อ่าน Traceback & กลยุทธ์ Debug", en: "" },
    lead: { th: "อ่าน error message ให้ขาด และไล่หา bug อย่างเป็นระบบ แทนการแก้มั่ว", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dbg-profiling": {
    slug: "dbg-profiling",
    title: { th: "Profiling — วัดว่าช้าตรงไหน", en: "" },
    lead: { th: "หาจุดที่ทำให้โปรแกรมช้าด้วยข้อมูลจริงจาก timeit และ cProfile แทนการเดา", en: "" },
    group: GROUP,
    blocks: {
      th: [
  ...
  "dbg-performance": {
    ...
    title: { th: "เทคนิคเพิ่มประสิทธิภาพ", en: "" },
    lead: { th: "พอ profile เจอจุดช้าแล้ว แก้อย่างถูกวิธี — เลือกโครงสร้างข้อมูลถูก และ cache ผลลัพธ์", en: "" },
    group: GROUP,
    blocks: {
      th: [
